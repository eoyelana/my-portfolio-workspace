...
export default function DomainCard({ title, description, href }: Domain) {
  return (
    <Link
      href={href}
      className="group flex flex-col justify-between rounded-2xl border border-white/10 bg-white/[.03] p-6 transition-all hover:-translate-y-1 hover:border-accent-to/50 hover:bg-white/[.05]"
    >
      <div>
